...
bool 
ModelBasedLineEstimation::processImageDemo(::cv::Mat img, cv::Vec4f &line, cv::Vec2f &centroid, bool display, int crop,  LineDetector::MODE mode)
{
...
bool ModelBasedLineEstimation::detectLineDemo(const ::cv::Mat img, cv::Vec4f &line, ::cv::Vec2f& centroid)
{
    ::cv::Mat thresholded;
...
void
ModelBasedLineEstimation::thresholdImageDemo(const ::cv::Mat& img, ::cv::Mat& out)
{
	::cv::Mat hsv;
	::std::vector<::cv::Mat> hsv_split;
